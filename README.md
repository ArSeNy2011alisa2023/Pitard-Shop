<html>
    <body>
        ...
        <head>
            <p class="res">
                За петардами только к нам
                </p>
                </head>
        <header class="shapka">
            <img id ="logo" src="/uploads/2020/12/logo_0_1607675596.svg" height="40px"/>
            <b>Внимание! Сезонные скидки 40% </b><a class="info" href="#discount">Подробнее</a>
        </header>
        <main>
            <nav>
            ...
            <p>
                <p class="text"><img class="terc" src="/uploads/2020/12/%D1%85%D0%BB%D0%BE%D0%BF%D1%83%D1%88%D0%BA%D0%B0_0_1607673818.svg" width="70px"/><br/>Хлопушки</p>
                <p class="text"><img class="terc" src="/uploads/2020/12/%D0%BF%D0%B5%D1%82%D0%B0%D1%80%D0%B4%D0%B0_0_1607673817.svg" width="70px"/><br/>Петарды</p>
                <p class="text"><img class="terc" src="/uploads/2020/12/%D1%84%D0%BE%D0%BD%D1%82%D0%B0%D0%BD_0_1607673817.svg" width="70px"/><br/>Фонтаны</p>
                <p class="text"><img class="terc" src="/uploads/2020/12/%D1%88%D0%B0%D1%80_0_1607673818.svg" width="70px"/><br/>Фестивальные шары</p>
            </p>
        ...
        <footer>
            <p class="tref" id="contacts"><b><i>Контакты</i></b></p>
            <p class="tref">Адрес: г. Звёздный, пр-кт. Экспериментальный, 21</p>
            <p class="tref">Тел.: 2502-3716</p>
        </footer>
    </body>
</html>
